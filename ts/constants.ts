...
export const FloodsubID = '/quorum/nevis/floodsub/1.0.0'

/**
 * The protocol ID for version 1.0.0 of the Gossipsub protocol
 * It is advertised along with GossipsubIDv11 for backwards compatability
 */
export const GossipsubIDv10 = '/quorum/nevis/meshsub/1.0.0'
 ...
 */
export const GossipsubIDv11 = '/quorum/nevis/meshsub/1.1.0'
